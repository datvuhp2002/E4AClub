        ...
        <div className="d-flex align-items-center justify-content-between">
          <div className=" d-flex fs-5">
            <Button
              ...
              transparent_btn
              onClick={() => router.push("/teacher/khoa-hoc/danh-sach")}
            >
              Quay lại
            </Button>
            <Button
              ...
              <div className="row">
                ...
                <div className="col-md-6 col-lg-6 mt-3">
                  ...
                  <div className={`row d-flex align-items-center mb-2`}>
                    <div className="col text-end fw-bold">Tiêu đề</div>
                  ...
                  {/* miêu tả */}
                  <div className={`row d-flex align-items-center mb-2`}>
                    <div className="col text-end fw-bold">Miêu tả</div>
                    <div className="col d-flex">
                      ...
                      <div className="col d-flex">
                        <div className=" fw-bold ">
                          ...
                          <Link
                            ...
                            href={`/teacher/khoa-hoc/danh-sach-hoc-vien/${params.id}`}
                          >
